...
def mk_surveys(stormDays, obsFreq, breedingDays, conf, complicate=True):
  """
...
def assign_fate( par, rng, trueFate,  intFinal, cn):
  """
...
def observer(nData, par, rng, surveys, stormDays, out, conf):
  ...
  out[:,3] = assign_fate(par,rng,fate,intFinal,conf)
