...
plCtlStorm = {
            ...
            # 'brDays': [180],
            # 'discProb': [0.8],
            # 'pMortFl'  : [0.5,0.9], # flood/storm severity
            'pMortFl'  : [0.7], # flood/storm severity
            # 'MCtype'   : ["none"],
...
plTest2 = {
            ...
            # 'numNests'  : [250,500], ## control values
            'numNests'  : [100], ## control values
            # 'probSurv' : [0.98],
